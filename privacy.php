...
<body>
  ...
  <nav>
    ...
    <ul class="nav-links">
      <li><a href="index.php#oferta">Cere ofertă</a></li>
  ...
  <div class="mobile-menu" id="mobile-menu" aria-hidden="true" inert>
    ...
    <ul class="mobile-nav-links" id="mobile-nav-links">
      <li><a href="index.php#oferta">Cere ofertă<span class="arrow">→</span></a></li>
      <li><a href="index.php#servicii">Servicii<span class="arrow">→</span></a></li>
      <li><a href="index.php#contact">Contact<span class="arrow">→</span></a></li>
    </ul>
  ...
  <main>
    <div class="priv-wrap">
      <a href="index.php" class="priv-back">← Înapoi la site</a>
