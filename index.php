...
<body>
  ...
  <!-- PARTENERI -->
  <section id="parteneri" style="
  padding:6rem 5%;
  background:
    linear-gradient(135deg, rgba(247,244,239,.97) 0%, rgba(247,244,239,.93) 50%, rgba(247,244,239,.85) 100%),
    url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=1920&q=85&auto=format&fit=crop') center/cover no-repeat;
">
  ...
  <script>
    ...
    function setActive() {
      ...
      let current = 0;
      sectionTops.forEach((top, i) => { if (scrollY >= top) current = i; });
